...
export default class EventView extends React.Component {
  ...
  render() {
    ...
    var otherStyle = {
      ...
      <div className='complogo'><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Google_%22G%22_Logo.svg/1024px-Google_%22G%22_Logo.svg.png" style={comp} /></div>
      ...
      <div contenteditable={this.editable} className='type'>In Person</div>
      <div contenteditable={this.editable} className='emotion'><img src="http://www.hey.fr/tools/emoji/ios_emoji_smiling_face_with_smiling_eyes.png" style={otherStyle}/></div>
      ...
      <button className='edit' onClick={this.editEvent}><img src="https://cdn3.iconfinder.com/data/icons/edition/100/pen_paper_2-512.png" style={otherStyle}/></button>
      <button className='save' onClick={this.submitEvent}><img src="https://cdn3.iconfinder.com/data/icons/vector-icons-for-mobile-apps-2/512/Save_black-512.png" style={otherStyle}/></button>
    </div>);
